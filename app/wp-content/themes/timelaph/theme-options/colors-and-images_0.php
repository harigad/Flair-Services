...
$options = array (
    ...
    array(  "name" => "Logo Image",
            "desc" => "Upload your image or select from the gallery.",
            "id" => "logo",
            "type" => "image",
    ...
    array(  "name" => "Background Image",
            ...
            "url" => get_bloginfo('stylesheet_directory')."/images/stars_bg.png"
    ),
