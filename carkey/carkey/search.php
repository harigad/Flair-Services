...
if($type=="feed" ){
	 ...
	 include_once 'functions/feed_get.php'; 

}else if($type=="checkin" ){

	 include_once 'functions/checkin.php'; 
	...
	include_once 'functions/editshare.php'; 
...
} else if ($type == "editradio") {
       
	   include_once 'functions/editradio.php';  
